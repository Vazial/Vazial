...
`2026-05-30 → 2026-09-18`  ·  **6** projects  ·  **98** sessions  ·  **1283** commits  ·  **1322** human prompts
...
| | | |
|---|---:|---|
| Verification pass rate | 93.8% | over 802 runs — checks that actually fail, so the gate is real |
| Rework rate | 10.8% | 135 fix/revert out of 1253 conventional commits |
| PR merge rate | 94.2% | 405 merged |
| Time to merge (median) | 0.39 h | p90 12.59 h |
| PR size (median) | 6 files | slices stay small |

Work delegated to each role agent, with how often that agent hit a tool error:

```
architect  █████████████████  139   tool errors 4.7%
designer   ██████              47   tool errors 3.8%
developer  ██████████████████ 148   tool errors 2.3%
tester     ███████             58   tool errors 2.1%
reviewer   ███                 27   tool errors 2.3%
```

Dispatch thins out toward the later roles — 139 runs of
...
<sub>Generated 2026-09-18 23:31 from session logs, <code>git log</code>, and GitHub Actions.</sub>
