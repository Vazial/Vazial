...
`2026-05-30 → 2026-09-11`  ·  **6** projects  ·  **94** sessions  ·  **986** commits  ·  **1241** human prompts
...
| Rework rate | 10.6% | 102 fix/revert out of 958 conventional commits |
...
```
architect  █████████████████  109   tool errors 5.2%
designer   ██████              37   tool errors 4.6%
developer  ██████████████████ 115   tool errors 2.5%
tester     ███████             45   tool errors 2.4%
reviewer   ███                 22   tool errors 2.7%
```

Dispatch thins out toward the later roles — 109 runs of
...
<sub>Generated 2026-09-11 23:31 from session logs, <code>git log</code>, and GitHub Actions.</sub>
