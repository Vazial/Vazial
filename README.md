...
`2026-05-30 → 2026-08-30`  ·  **5** projects  ·  **84** sessions  ·  **867** commits  ·  **1006** human prompts
...
| Rework rate | 8.9% | 75 fix/revert out of 840 conventional commits |
| PR merge rate | 95.8% | 365 merged |
...
<sub>Generated 2026-08-31 06:52 from session logs, <code>git log</code>, and GitHub Actions.</sub>
