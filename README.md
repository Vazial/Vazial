...
`2026-05-30 → 2026-09-08`  ·  **6** projects  ·  **92** sessions  ·  **963** commits  ·  **1225** human prompts
...
| | | |
|---|---:|---|
| Verification pass rate | 97.0% | over 402 runs — checks that actually fail, so the gate is real |
| Rework rate | 10.7% | 100 fix/revert out of 935 conventional commits |
...
```
architect  █████████████████  103   tool errors 5.4%
designer   ██████              36   tool errors 4.6%
developer  ██████████████████ 111   tool errors 2.6%
tester     ██████              39   tool errors 2.5%
reviewer   ███                 21   tool errors 2.8%
```

Dispatch thins out toward the later roles — 103 runs of
...
<sub>Generated 2026-09-08 23:31 from session logs, <code>git log</code>, and GitHub Actions.</sub>
